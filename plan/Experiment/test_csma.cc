...
main (int argc, char *argv[])
{
  ...
  uint32_t NumOfNodes=4;
  CommandLine cmd;
  cmd.AddValue("NumOfNodes","the number of nodes on the channel ",NumOfNodes);
  cmd.Parse (argc, argv);
  ...
  CsmaHelper csma;
  //csma.SetChannelAttribute ("DataRate", DataRateValue (DataRate (0x1000)));
  csma.SetChannelAttribute ("DataRate", DataRateValue (DataRate (0x4000)));
  ...
  csma.EnableAsciiAll (ascii.CreateFileStream ("test-csma-broadcast.tr"));
  ...
  csma.EnablePcapAll ("test-csma-broadcast", true);
